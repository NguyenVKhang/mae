...
def cross_entropy(seq_out, pos_emb, neg_emb, tar_msk):
    seq_emb = seq_out.view(-1, args.latdim+512)
    pos_emb = pos_emb.view(-1, args.latdim+512)
    neg_emb = neg_emb.view(-1, args.latdim+512)
    # print("Shape of seq_emb:", seq_emb.shape)
    # print("Shape of pos_emb:", pos_emb.shape)
    # print("Shape of neg_emb:", neg_emb.shape)
    pos_scr = t.sum(pos_emb * seq_emb, -1)
    neg_scr = t.sum(neg_emb * seq_emb, -1)
    tar_msk = tar_msk.view(-1).float()
    # print("Shape of pos_scr:", pos_scr.shape)
    # print("Shape of neg_scr:", neg_scr.shape)
    # print("Shape of tar_msk:", tar_msk.shape)
